		...
		fr: {
			...
			valeurs: [{
				...
				valeur: "Récemment certifié en Agilité, via <strong> Scrum.org </strong> ( <a href='https://www.scrum.org/certification-list' target='_blank'> PSM 1 / PSPO 1 </a> ). Les valeurs de l'agilité m'animent ... au point de me demander, comment a t-on fait jusqu'à maintenant ?!? <br /> Certainement, je souhaites continuer à oeuvrer dans un contexte agile, et améliorer mes pratiques au quotidient. <br />" +
						...
						"Les changements culturels en court dans notre société, rendent l'époque formidable. En ce qui me concerne, je n'ai jamais travaillé en mode cascade, et je m'en félicite !"
				}, {
				titre: "engagement",
				icon: "lock",
				...
				valeur: "Curieux insatiable, j'ai besoin au quotidient de nourrir cette soif d'apprendre, et de progresser. <br />" +
					"Que ce soit un nouvel outil, un language, un nouveau concept. Je cherche constament à étendre et approfondir mes connaissances." +
					"C'est ce voyage parmis les connaissances et les innovations de notre époque qui donne <strong> du sens à la vie ! </strong> <br />"
			} ],
			competences: [ 
		...
		uk: {
			...
			experiences: [ 
				{ "experience": {
					"entreprise": "{ PERSO }",
					"logo": "./images/pmu_logo.png",
					"img_alt": "logo client PMU / project Hippigo",
				...
				{ "experience": {
					...
					"lignes_description": [
						...
						"Geolocatlisation and time stamping",
						"Déploiement de l'app sur les stores IOS / Android et Windows Phone",
					...
					"autres": [
							...
							"description": "<strong> CONTEXTxE </strong>: NiyaStudio <br />" +
									"Personnal business" +
